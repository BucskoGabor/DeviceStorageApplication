 ...
 *
 * <p>Testcontainers PostgreSQL + valódi Flyway migrációk + valódi Argon2 hash.
 * A MockMvc a teljes Spring context-et felépíti, így a Security Filter Chain
 * (JwtAuthenticationFilter, RateLimitFilter, stb.) is valódi.
 */
