 ...
 *
 * <ul>
 *   <li>cleanup() hívja a ScheduledJobMonitoring.run() metódust
 *   <li>doCleanup() átadja a 7 napos grace cutoff-ot a repository-nak
 *   <li>doCleanup() logolja a törölt tokenek számát
 *   <li>cleanup() hiba esetén email alert-et küld (monitoring-on keresztül)
 * </ul>
 */
...
class RefreshTokenCleanupJobTest {
  ...
  void setUp() {
    ...
    doAnswer(
        ...
        .when(jobMonitoring)
        .run(anyString(), any(Runnable.class));
  }
