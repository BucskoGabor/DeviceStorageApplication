 ...
 *
 * <p>A @Retryable logikát Spring Boot Integration Test-tel kellene tesztelni, de unit szinten
 * ellenőrizzük a retry konfigurációt és az alapvető viselkedést.
 *
 * <p>Megjegyzés: A Spring Retry annotáció csak Spring context-ben aktív, ezért a retry viselkedést
 * itt manuálisan teszteljük.
 */
