...
/**
 * Smoke test — ellenőrzi, hogy a Spring Boot alkalmazás kontextusa betöltődik. A Task 1.2-ben ez az
 * első ellenőrzés.
 *
 ...
 *
 * <p>H2 in-memory database-t használ a teszt, mert a PostgreSQL konténer még nem elérhető. A Flyway
