 ...
 * <p>Teszteli:
 * <ul>
 *   <li>Egyszintű fa (csak root node-ok) helyes visszaadása</li>
 *   <li>Többszintű fa rekurzív bejárása</li>
 *   <li>Üres fa (nincs root node) üres listát ad</li>
 *   <li>MAX_TREE_DEPTH (10) korlát működése</li>
 * </ul>
 */
...
class LocationServiceTreeTest {
    ...
    private Location locationWithChildren(Long id, String name, LocationType type, List<Location> children) {
