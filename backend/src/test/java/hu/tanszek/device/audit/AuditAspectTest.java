 ...
 *
 * <p>Az AOP @Around advice-t nem teszteljük unit szinten (integrációs tesztben
 * lenne értelme, Task 5.3). A maszkoló és diff segédmetódusokat közvetlenül
 * hívjuk reflection-nel.
 */
class AuditAspectTest {
    ...
    void buildChangesJsonProducesBeforeAfterStructure() throws Exception {
        var method = AuditAspect.class.getDeclaredMethod("buildChangesJson", Object.class, Object.class);
        method.setAccessible(true);
