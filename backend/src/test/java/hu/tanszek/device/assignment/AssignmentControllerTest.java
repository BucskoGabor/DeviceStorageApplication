 ...
 *
 * <p>A service-szintű unit tesztek a DeviceServiceTest-ben vannak (DeviceService az, ami a
 * tényleges state machine logikát tartalmazza). Itt csak a controller szintű delegációt és a
 * SecurityContext → userId feloldást teszteljük.
 */
...
class AssignmentControllerTest {
  ...
  void findPending_returnsOnlyPendingStatuses() {
    ...
    assertThat(response.getBody())
        ...
        .containsExactlyInAnyOrder(
            AssignmentStatus.PENDING_ASSIGNMENT, AssignmentStatus.PENDING_UNASSIGNMENT);
  }
  ...
  void findByDevice_throwsWhenDeviceNotFound() {
    ...
    org.assertj.core.api.Assertions.assertThatThrownBy(() -> controller.findByDevice(99L, 0, 20))
