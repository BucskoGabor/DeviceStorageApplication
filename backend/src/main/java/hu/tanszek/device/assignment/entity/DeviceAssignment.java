 ...
 *
 * <p>Egy device-hoz egy időben csak egy aktív rekord tartozik ({@code active = true}). A history
 * ugyanebben a táblában van, inaktív rekordok formájában.
 *
 * <p>State machine:
 *
 * <pre>
 ...
 *
 * <ul>
 *   <li>A {@code to_location_id} NEM lehet {@code LocationType.GROUP} típusú
 *   <li>A {@code from_location_id} NEM lehet {@code LocationType.GROUP} típusú
 *   <li>A device státusza NEM lehet {@code MAINTENANCE} vagy {@code DISPOSED}
 * </ul>
 *
