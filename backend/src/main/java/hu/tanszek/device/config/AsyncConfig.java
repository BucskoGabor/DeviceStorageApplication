 ...
 *
 * <p>Az MDC (request_id, user_id, stb.) nem propagálódik automatikusan a @Async metódusokon — a
 * TaskDecorator lemásolja az MDC-t a háttér-thread-re, hogy az async log-ok is tartalmazzák a
 * request_id-t.
 *
 * <p>Az MDC.put/remove manuálisan kell az async metódus végén cleanup-olni, de a Spring
 * 6.x @AutoClose MDC-vel automatikusan cleanup-ol.
 */
@Configuration
public class AsyncConfig implements AsyncConfigurer {
   ...
   *
   * <p>Így az async log-ok (audit log write, email küldés) is tartalmazzák a request_id-t,
   * user_email-t, stb.
   */
