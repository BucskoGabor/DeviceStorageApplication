...
/**
 * SeedPasswordInitializer — induláskor ellenőrzi, hogy a demo admin user password_hash-e
 * placeholder, és ha igen, generál egy valódi Argon2id hash-t.
 *
 * <p>Ez azért szükséges, mert a V2__seed.sql-ben a password_hash placeholder (a Flyway migration-ök
 * nem generálhatnak jelszó hash-t — a salt random), és a LocalAuthProvider jelszó-ellenőrzése a
 * valódi Argon2 hash-t vár.
 *
 * <p>Induláskor egyszer fut le. Ha a demo admin user password_hash-e placeholder, generál egy új
 * Argon2id hash-t a 'ChangeMe123!' jelszóhoz, és frissíti a DB-t. A mustChangePassword=true flag
 * biztosítja, hogy az első login után a user megváltoztassa a jelszavát.
 */
@Slf4j
@Component
