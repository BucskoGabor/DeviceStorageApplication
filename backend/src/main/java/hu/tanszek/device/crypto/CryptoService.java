 ...
 *
 * <ul>
 *   <li><b>AES-GCM 256</b> — {@code email_encrypted} és {@code license_key_encrypted} mezők
 ...
 *   <li><b>Argon2id</b> — jelszavakhoz (a Spring Security {@code Argon2PasswordEncoder}-en
 *       keresztül)
 * </ul>
 *
 * <p>Az {@link hu.tanszek.device.user.entity.AppUser} entitás használja az encrypt(email) és
 * sha256(email) metódusokat a mentéskor, a {@link hu.tanszek.device.software.entity.Software}
 * entitás pedig az encrypt(licenseKey) hívást a {@code license_key_encrypted} mezőhöz.
 *
...
public interface CryptoService {
   ...
   *
   * <p>A visszaadott string formátuma: {@code <base64-iv>:<base64-ciphertext>}. Az IV
   * (Initialization Vector) random 12 byte, minden hívásban új, így azonos plaintext különböző
   * ciphertext-et eredményez.
   *
   ...
   * @throws CryptoException ha a visszafejtés sikertelen (pl. tampering, rossz kulcs)
   */
