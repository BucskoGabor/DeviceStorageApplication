...
public interface DeviceRepository
  ...
  @Query(
      "SELECT s.id, d.inventoryNumber FROM Device d JOIN d.softwares s WHERE s.id IN :softwareIds ORDER BY d.inventoryNumber ASC")
  List<Object[]> findDeviceInventoryNumbersBySoftwareIds(
      @Param("softwareIds") Collection<Long> softwareIds);
