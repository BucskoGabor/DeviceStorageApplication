 ...
 * Eszköz státuszok.
 *
 * <p>A {@code LocationService.assign()} és {@code DeviceService.delete()}
 * metódusok ellenőrzik a státuszt — a {@link #MAINTENANCE} és
 * {@link #DISPOSED} állapotú eszközökre NEM lehet assignolni vagy
 * törölni.
 *
