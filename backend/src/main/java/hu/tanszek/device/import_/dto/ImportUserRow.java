 ...
 *
 * <ul>
 *   <li>Ha az email_hash már létezik → UPDATE (meglévő user frissítése)
 *   <li>Ha nem létezik → INSERT (új user létrehozása)
 * </ul>
 */
public record ImportUserRow(
    @NotBlank(message = "validation.notBlank")
        ...
        String email,
    @NotBlank(message = "validation.notBlank") @Size(max = SizeLimits.SHORT_TEXT_MAX)
        String firstName,
    @NotBlank(message = "validation.notBlank") @Size(max = SizeLimits.SHORT_TEXT_MAX)
        String lastName,
    @NotBlank(message = "validation.notBlank")
    ...
    @Size(max = SizeLimits.MEDIUM_TEXT_MAX) String officeLocationName // optional — iroda neve
    ) {}
