 ...
 *
 * <ul>
 *   <li>Ha az inventory_number már létezik → UPDATE
 *   <li>Ha nem létezik → INSERT
 * </ul>
 */
public record ImportDeviceRow(
    @NotBlank(message = "validation.notBlank") @Size(max = SizeLimits.INVENTORY_NUMBER_MAX)
    ...
    @Size(max = SizeLimits.MEDIUM_TEXT_MAX) String locationName // optional — kezdeti location neve
    ) {}
