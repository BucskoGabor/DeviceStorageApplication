 ...
 *
 * <p>Fájlok fizikai tárolása: {@code ./uploads/devices/{device_id}/{uuid}.{ext}} lokális volume
 * mount-on ({@code uploads_data:/var/uploads}).
 *
 * <p>Limits:
 *
 * <ul>
 *   <li>Max 5MB/fájl (validálás upload endpointon)
 *   <li>Max 5 fájl/device (service check)
 * </ul>
 *
 * <p>Cascade policy: device törlésekor az attachment rekordok ÉS a fizikai fájlok is törlődnek
 * (lásd {@code AttachmentService.deleteByDevice}).
 *
