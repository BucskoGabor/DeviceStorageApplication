 ...
 *
 * <p>A service-szintű metódusok {@code @AuditTarget} annotációval vannak ellátva, így az AOP audit
 * interceptor (lásd {@code AuditAspect}) minden módosítást automatikusan naplóz az {@code
 * audit_logs} táblába.
 *
 * <p>Licence key kezelés:
 *
 * <ul>
 *   <li>{@link #create(String, String)} — új szoftver létrehozása titkosított kulccsal
 *   <li>{@link #update(Long, String, String)} — partial update (csak a nem-null mezők)
 *   <li>{@link #delete(Long)} — szoftver törlése (a join tábla bejegyzések manuálisan tisztítandók
 *       a DB cascade által)
 * </ul>
 */
@Slf4j
  ...
  private void validateName(String name) {
    if (name == null || name.isBlank()) {
      throw new BusinessValidationException(
          "validation.nameNotBlank", "Software name cannot be blank");
    }
  }
}
