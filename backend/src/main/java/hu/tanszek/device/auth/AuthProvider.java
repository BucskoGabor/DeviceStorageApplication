 ...
 *
 * <p>Az interface célja, hogy a rendszer több auth provider-t támogathasson (LOCAL: Argon2 + DB;
 * AD: LDAP; OAuth2: stb.) anélkül, hogy a hívó kód változna. Az {@link AuthProviderFactory}
 * választja ki az aktív implementációt a {@code configs.AUTH_PROVIDER} értéke alapján.
 *
 * <p>Használat:
 *
 * <pre>
...
public interface AuthProvider extends AuthenticationProvider {
   ...
   * @return Spring Security {@link Authentication} object a sikeres hitelesítés után (username +
   *     role/permission authorities)
