 ...
 *
 * <p>Filter pozíció: Security Filter Chain 2. lépése (a CsrfFilter előtt), hogy a brute-force botok
 * ne kapjanak CSRF tokent a próbálkozásaik során.
 *
 * <p>A /api/auth/login endpointra két rate limitet alkalmazunk:
 *
 * <ul>
 *   <li>Per-IP: 5 próba / perc — gyors brute-force védelem
 *   <li>Per-email: 10 próba / óra — lassabb targeted attack védelem
 * </ul>
 *
 * <p>Ha bármelyik bucket üres, {@link BusinessValidationException} dobódik, amit a {@code
 * GlobalExceptionHandler} 429-es státusszal kezel ({@code rateLimitExceeded} messageKey).
 */
@Slf4j
@Component
  ...
  private static class CachedBodyHttpServletRequest
    ...
    public jakarta.servlet.ServletInputStream getInputStream() {
      java.io.ByteArrayInputStream byteArrayInputStream =
          new java.io.ByteArrayInputStream(this.cachedBody);
