 ...
 *
 * <p>A {@code @ConfigurationProperties} annotációval a Spring Boot automatikusan bind-eli az
 * application.yml-ből az értékeket:
 *
 * <pre>
 * jwt:
 ...
 * </pre>
 *
 * <p>A {@link #setActiveKey(String)} setter dekódolja a base64 secret-et és beállítja a {@link
 * #decodedActiveKey}-et. Ha a kulcs hossza nem 32+ byte (HS256 minimum 256 bit), a setter
 * IllegalStateException-t dob fail-fast indításkor.
 */
@Getter
@Setter
@Component
