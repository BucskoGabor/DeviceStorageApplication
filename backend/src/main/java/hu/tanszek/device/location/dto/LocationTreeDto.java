 ...
 *
 * <p>A {@link Location} entitás {@code children} kollekciója {@code @JsonIgnore}-elt
 * (LAZY fetch elkerülése végett), ezért ez a DTO szolgál a fa megjelenítésére.
 *
 * <p>A tree építése service-szinten történik (lásd {@code LocationController.findTree}),
 * hogy a JSON válasz garantáltan véges mélységű és a ciklusok ellen védett.
 */
