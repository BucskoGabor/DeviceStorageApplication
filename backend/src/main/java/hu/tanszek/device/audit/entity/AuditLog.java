 ...
 *
 * <p>Minden írási művelet automatikusan naplózódik az AOP Audit Interceptor által (lásd {@code
 * AuditAspect}). A {@code changesJson} mező a rollback-hez kell: {@code {"before": {...}, "after":
 * {...}}}.
 *
 * <p>Rollback szabályok:
 *
 * <ul>
 *   <li>Update rollback: {@code after} → {@code before}
 *   <li>Create rollback: {@code after == null, before != null} → törölje az entitást
 *   <li>Delete rollback: {@code before != null, after == null} → visszaállítja a törölt entitást
 * </ul>
 *
 * <p>Retention policy: 1 év után archiválás, 5 év után végleges törlés (lásd {@code
 * AuditRetentionJob}).
 *
