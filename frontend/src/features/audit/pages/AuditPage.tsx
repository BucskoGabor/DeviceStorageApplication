  ...
  return (
    <>
      <div className="space-y-6">
        ...
        {/* Diff side panel */}
        {selectedLog && (
          <div className="fixed inset-0 z-50 bg-black/50" onClick={() => setSelectedLog(null)}>
            <div
                ...
                <Card className="mb-4">
                  <CardHeader className="py-3">
                    <CardTitle className="text-sm">
                      {t('audit.requestPayload', 'Kérelem adatai (Request Payload)')}
                    </CardTitle>
                  </CardHeader>
                  <CardContent className="py-2">
                    <pre className="overflow-x-auto whitespace-pre-wrap rounded bg-muted/60 p-3 font-mono text-xs">
                      {selectedLog.requestPayload}
                    </pre>
                  </CardContent>
                </Card>
